...
<body class="text-black font-poppins pt-10 pb-[50px]">
    ...
    <section id="Top-Categories" class="max-w-[1200px] mx-auto flex flex-col p-[70px_50px] gap-[30px]">
        ...
        <div class="grid grid-cols-3 gap-[30px]">
            @foreach ($categoriesBottom as $category)
                <a href="{{ route('front.category', $category->slug) }}"
                    class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                    <div class="w-[70px] h-[70px] flex shrink-0">
                        <img src="{{ Storage::url($category->icon) }}" class="object-contain" alt="icon">
        ...
        {{-- <div class="grid grid-cols-3 gap-[30px]">
            <a href="{{ route('front.category', 'data-science') }}"
                class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-1.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Data Science</p>
            </a>
            <a href="{{ route('front.category', 'uiux-design') }}"
                class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-4.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">UI/UX Design <br> Copywriting</p>
            </a>
            <a href="{{ route('front.category', 'software-quality-assuranse') }}"
                class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
        ...
        {{-- <a href="{{ route('front.category', 'software-development') }}"
            ...
            <a href="{{ route('front.category', 'digital-marketing') }}"
                class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-1.svg" class="object-contain" alt="icon">
                </div>
            ...
            <a href="{{ route('front.category', 'bussiness-intelligence') }}"
                class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
            ...
            <a href="{{ route('front.category', 'data-analytics') }}"
                ...
                <p class="font-bold text-lg">Data Analytics</p>
            </a> --}}
        </div>
                        ...
                        <div
                            ...
                            <div class="flex flex-col px-4 gap-[10px]">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex flex-col">
                                        <p class="font-semibold">{{ ucfirst($course->teacher->user->name) }}</p>
