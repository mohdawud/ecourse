...
<body class="text-black font-poppins pt-10">
    <div id="checkout-section" style=" background-image: url('{{ asset('assets/background/Hero-Banner.png') }}')"
        class="max-w-[1200px] mx-auto w-full min-h-[calc(100vh-30px)] flex flex-col gap-[30px]  bg-center bg-no-repeat bg-cover rounded-[32px] overflow-hidden relative pb-6">
